...
const ProfileForm = ({
  ...
  // method to record changes to the form
  const onChange = (e) =>
      ...
      <form className="form" onSubmit={onSubmit}>
        <div className="form-group">
          <select name="status" value={status} onChange={onChange}>
            ...
            <option value="Instuctor">Instuctor or Teacher</option>
        ...
        <div className="form-group">
          ...
          />
          <small className="form-text">
            City and Province/State suggested (eg. Victoria, BC)
          </small>
        </div>
        <div className="form-group">
          <input
        ...
        {/* Show Social Media inputs if they are toggled on */}
        {displaySocialInputs && (
          <Fragment>
